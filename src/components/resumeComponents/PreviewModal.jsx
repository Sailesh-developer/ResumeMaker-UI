        ...
        <div className="bg-black/70 flex items-center justify-center z-1000 ">
            ...
            <div className="flex flex-col items-center gap-4">
                <div className="flex flex-row items-center gap-4">
                 ...
                 {/* <div ref={resumeRef}> */}
                  <div className="w-[210mm] h-[297mm] bg-white p-[10mm] box-border text-[13px] leading-5">
                  ...
                  {/* Technical skills start */}
                    <div className="mt-5">
                        <span className="text-[19px] font-bold relative">TECHNICAL SKILLS</span>
                          <div className="border-b border-black w-full mt-1"></div>
                        <div className="flex flex-col">
                            <div>
                               <span className="text-[13px] font-bold relative">Languages:</span>
                               <span className="text-[13px] ml-1"> {languages}</span>
                            </div>
                             <div>
                               <span className="text-[13px] font-bold relative">Development:</span>
                                <span className="text-[13px] ml-1"> {frameworks}</span>
                             </div>
                              <div>
                               <span className="text-[13px] font-bold relative">Platforms:</span>
                  ...
                  <div className="mt-2 relative">
                    <span className="text-[19px] font-bold relative">WORK EXPERIENCE</span>
                    <div className="border-b border-black w-full mt-1 relative"></div>
                      <div className="flex flex-col relative">
                         <div className="flex flex-col relative">
                               <span className="text-[13px] font-bold mt-1 relative">{WorkProjectTitleOne}</span>
                               <span className="text-[13px] ml-1 mt-2 relative"> 
                                {workDescriptionOne.map((point,index) => (
                                      <ul key={index} className="list-disc pl-3 relative">
                                         <li>{point}</li>
                                      </ul>
                                ))
                                }
                                </span>
                               <span className="text-[13px] font-bold mt-1 relative">{WorkProjectTitleTwo}</span>
                               <span className="text-[13px] ml-1 mt-2 relative"> 
         ...
         <div className="w-[210mm] h-[297mm] bg-white p-[10mm] box-border text-[13px] leading-5 relative">
                         <div className="mt-2 relative">
                    <span className="text-[19px] font-bold relative">PROJECTS</span>
                    <div className="border-b border-black w-full mt-1 relative"></div>
                      <div className="flex flex-col relative">
                         <div className="flex flex-col relative">
                               <span className="text-[13px] font-bold mt-1 relative">{WorkProjectTitleOne}</span>
